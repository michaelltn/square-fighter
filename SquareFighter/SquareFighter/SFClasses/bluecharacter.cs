...
{
    class BlueCharacter : SFCharacter
    {
        ...
        {
            this.lineColor = new Color(0, 162, 232);
            this.lineThickness = 7;

            body = new SFSquare(new Rectangle(-20, -70, 40, 60));
            body.lineColor = this.lineColor;
            body.lineThickness = this.lineThickness;

            arm1 = new SFSquare(new Rectangle(10, -50, 20, 20));
            arm1.lineColor = this.lineColor;
            arm1.lineThickness = this.lineThickness;

            arm2 = new SFSquare(new Rectangle(-20, -50, 20, 20));
        ...
        override protected void setupIdleAnim()
        {
            ...
            if (anim != null)
            {
                ...
                anim.addFrame(body.defaultRect, 0.4f);
            }
            ...
            {
                anim.addFrame(otherRect, 0.4f);
                anim.addFrame(arm1.defaultRect, 0.4f);
            }
            ...
            {
                anim.addFrame(otherRect, 0.4f);
                anim.addFrame(arm2.defaultRect, 0.4f);
            }
            ...
            {
                anim.addFrame(otherRect, 0.4f);
                anim.addFrame(leg1.defaultRect, 0.4f);
            }
            ...
            {
                anim.addFrame(otherRect, 0.4f);
                anim.addFrame(leg2.defaultRect, 0.4f);
            }
        ...
        override protected void setupWalkForwardAnim()
        {
            ...
            if (anim != null)
            {
                ...
                anim.addFrame(otherRect2, 0.25f);
        ...
        override protected void setupJumpAnim()
        {
            ...
            {
                anim.addFrame(otherRect, 0.1f);
                anim.addFrame(otherRect2, 0.65f);
            }
            this.addAnimation(SFCharacter.CharacterPiece.Leg1, anim);
        ...
        override protected void setupPunchAnim()
        {
            ...
            otherRect2.Y -= otherRect2.Height * 3;
            otherRect2.Width += 5;
            otherRect2.Height += 5;

            anim = SFAnimation.Create(PunchAnimRef, arm1.defaultRect, 5);
            if (anim != null)
            {
                anim.addFrame(otherRect, 0.1f);
                anim.addFrame(otherRect2, 0.2f);
                anim.addFrame(otherRect, 0.3f);
                anim.addFrame(arm1.defaultRect, 0.1f);
            }
            this.addAnimation(SFCharacter.CharacterPiece.Arm1, anim);
        }
        ...
        override protected void setupKickAnim()
        {
            ...
            otherRect2 = otherRect;
            otherRect2.X += otherRect2.Width * 3;
            otherRect2.Y -= otherRect2.Height / 2;
            otherRect2.Width += 5;
            otherRect2.Height += 5;

            anim = SFAnimation.Create(KickAnimRef, leg1.defaultRect, 5);
            if (anim != null)
            {
                anim.addFrame(otherRect, 0.1f);
                anim.addFrame(otherRect2, 0.2f);
        ...
        override protected void setupSpecialAnim()
        {
            ...
            SetSpeicalAnimationTrackingSquare(arm2);
            ...
            if (anim != null)
            {
                ...
                anim.addFrame(arm2.defaultRect, 0.2f);
            }
            this.addAnimation(SFCharacter.CharacterPiece.Arm2, anim);
            ...
            if (anim != null)
            {
                anim.addFrame(otherRect, 0.5f);
                anim.addFrame(arm1.defaultRect, 0.2f);
            }
            this.addAnimation(SFCharacter.CharacterPiece.Arm1, anim);
            ...
            otherRect.Width += 10;
            otherRect.X -= 5;
            anim = SFAnimation.Create(SpecialAnimRef, body.defaultRect, 3);
            if (anim != null)
            {
                anim.addFrame(otherRect, 0.4f);
                anim.addFrame(body.defaultRect, 0.10f);
            }
            this.addAnimation(SFCharacter.CharacterPiece.Body, anim);
        }
